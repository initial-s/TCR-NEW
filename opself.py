...
ki.login(token="ElHijfi5d8EEw0oJg3K5.2MEDguZXZnXI+n0eT1GqXq.gTGhu3+/gdJHQirm1avx5xmW4+Q1KLyZS19cAroKU5Q=")
ki.loginResult()

kk = LINETCR.LINE() #Zorro
kk.login(token="ElqobeHtTSoa3rQMeRi3.Gb6Qn331R6g2Wz0CsOsN0W.wEJidLuv2IXWEtv6C8OZzocG0OV5O6zb7Sa8Vn67E0w=")
kk.loginResult()

kc = LINETCR.LINE() #Sanji
kc.login(token="ElZageFErf2aai3xiNGe.W4nNn5a7f7Ny+JDgQw0hFG.X+PiQlbD9sNvOk2xmv7Cs3NvuD/O81ohRE/ov38U2pc=")
kc.loginResult()

ks = LINETCR.LINE() #Ussop
ks.login(token="ElVUY1fzfZrX6raoHUL1.znOFgwZ3Bpwf7NyOO3RLaq.ZaCe2K0h1w3iXUXsLAqGfxkqJpTyvnPyMGv4nnHShcY=")
ks.loginResult()

ka = LINETCR.LINE() #Chooper
ka.login(token="Elwj51B8Iua0euPovTJc.jf+XttKo1MOAZLcxBzIH+a.6Qm3oeFbfR9rRcZ+ybkya8Ox5IS/8Kyl+IfxhOF+h/k=")
ka.loginResult()

kb = LINETCR.LINE() #Franky
kb.login(token="El0ZOS3tnbB93N7iumP6.ThIZGMdUGG5NlyD4epVVnG.numswW7q5MTDBpixXFl0EVGciIGwCQMf1u/AMlzlS4g=")
kb.loginResult()

ko = LINETCR.LINE() #Brook
ko.login(token="ElT7GljgzFv1Iys0mA27.7b656S5SXJP+IQ3XR7YA9W.RjHETCwM7xN2eTVTpcjJ6uxDn80pmeaLQFSo7Hd2w6A=")
ko.loginResult()

ke = LINETCR.LINE() #Nami
ke.login(token="ElMmGcldrOeHLCjoSt50.A8sXP7Df+/Ovd4ui1UKIGa.YiOgT+5T+xqF7tFNVi4cI25qUNT4ZvDwCwKybGeOLdk=")
ke.loginResult()

ku = LINETCR.LINE() #Robin
ku.login(token="El68IkFsh4QmEq2bblj0.Y00CqhaENcteJzCWN27b8a.aCmhSEu12H2pZHt1muDK7DmJTRIIUUBhrnywL7V+8aI=")
ku.loginResult()
...
admin=["ued156c86ffa56024c0acba16f7889e6d","u2d76b3ee0f0795aa93d29bdfb5f2172c","uad208d16f70d0cc48645b9f5d5909936","u5ddba0b0366f32d148979ef879edf1f0"] # Koplaxs,mamih,awil
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                ...
                ki.sendText(msg.to,"Luffy On")
                kk.sendText(msg.to,"Zorro On")
                kc.sendText(msg.to,"Sanji On")
                ks.sendText(msg.to,"Ussop On")
                ka.sendText(msg.to,"Chooper On")
                kb.sendText(msg.to,"Franky On")
                ko.sendText(msg.to,"Brook On")
                ke.sendText(msg.to,"Nami On")
                ku.sendText(msg.to,"Nico Robin On")
